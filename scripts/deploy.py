...
def main():
    with networks.parse_network_choice("arbitrum:mainnet:alchemy") as provider:
        ...
        gasFeeWallet = "0x26075E00a66415398bdD773DF080DAdd6f26C18F"
        gasFee = 1500000000000000
        competitionArb = project.competitionArb.deploy(compass, reward, factory, admin, investor, gasFeeWallet, gasFee, sender=acct)
